          ...
          <ul>
            {
              props.messages?.map((message, key) => (
                <li key={key} className="leading-relaxed text-[#CD5D5D]">
                  {message}
                </li>
              ))
            }
      ...
      <div className="flex w-full border-l-6 border-warning bg-warning bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
        ...
        <div className="w-full">
          ...
          <ul>
            {
              props.messages?.map((message, key) => (
                <li key={key} className="leading-relaxed text-[#D0915C]">
                  {message}
                </li>
              ))
            }
      ...
      <div className="flex w-full border-l-6 border-[#34D399] bg-[#34D399] bg-opacity-[15%] px-7 py-8 shadow-md dark:bg-[#1B1B24] dark:bg-opacity-30 md:p-9">
        ...
        <div className="w-full">
          ...
          <ul>
            {
              props.messages?.map((message, key) => (
                <li key={key} className="text-base leading-relaxed text-body">
                  {message}
                </li>
              ))
            }
