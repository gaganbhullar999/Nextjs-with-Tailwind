...
import 'pathology_test_screen.dart';
...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  bool tests2Found = false;
  bool packagesFound = false;
  bool packages2Found = false;
  ...
  void initState() {
    ...
    dashboardController.getAllTestsByType("1").then((value) {
      tests2Found = value.data?.isNotEmpty == true;
    }).catchError((err) {});
    /* dashboardController.getPackagesbyType("1").then((value) {
      packages2Found = value.data?.isNotEmpty == true;
    }).catchError((err) {}); */
  }
